...
weight = 30
eyebrow = "Handbook"
lead = "Venue hosts make our meetups possible. Hosting means providing a space for an evening; the PyLadies organizing team handles all the coordination, promotion, and running of the event."
+++
...
- Most venues ask us to sign an **event hosting agreement** covering booking lead time,
  setup/cleanup, access procedures, and a cancellation policy, and we're happy to work within
  these.
...
{{< button url="mailto:vancouver@pyladies.com" label="Get in touch" icon="fa-solid fa-location-dot" >}}
