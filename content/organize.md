...
weight = 50
eyebrow = "Handbook"
lead = "Organizing our events is a team effort, and there's room for lots of hands. Most of the ways to pitch in don't need any special access or accounts: especially blog write-ups and design work."
+++
...
- **Write blog recaps**: turn an event into a write-up for the site (see
  [Contributing to the Website](/contributing/))
- **Design assets**: posters, social graphics, and event banners
- **Speak or host**: see [Speak at our meetup](/speak/) and [Host a venue](/host/)
...
you up. No experience required. The step-by-step guides for each stage of running a meetup
are in the [Meetup Runbooks](/runbooks/).
...
{{% callout tone="warn" title="A note for organizers" %}}
